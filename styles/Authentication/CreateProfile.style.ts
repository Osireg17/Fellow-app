...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    marginBottom: 30,
    marginTop: 20,
    color: '#59ADFF', // Update the color of the title
  },
  label: {
    fontSize: 16,
    fontWeight: 'bold',
    ...
    marginLeft: 15,
    marginTop: 10,
    color: '#59ADFF', // Update the color of the label
  },
  input: {
    height: 40,
    width: '80%',
  ...
  profileImageSelector: {
    ...
    borderRadius: 50,
    borderWidth: 1,
    borderColor: '#59ADFF', // Update the color of the profile image border
    justifyContent: 'center',
    alignItems: 'center',
    marginBottom: 20,
  },
  ...
  saveButton: {
    backgroundColor: '#59ADFF', // Update the background color of the save button
    borderRadius: 5,
    width: '80%',
    marginTop: 20,
    marginBottom: 20,
