                        ...
                        <Text style={styles.questionTitle}>{question.title}</Text>   
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                { question.type === "public" ? (
                                    <>
                                    <Text style={styles.questionUsername}>{question.username}</Text>
                                        <Image source={{ uri: question.userProfilePicture || 'https://via.placeholder.com/40' }} style={styles.questionUserImage}/>
                                    </>
                                    ) : (
